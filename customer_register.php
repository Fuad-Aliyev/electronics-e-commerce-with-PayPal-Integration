			...
			<div id="content_area">  
				...
				<div id="shopping_cart">
					<span style="font-size: 18px;padding: 5px;line-height: 40px;">
						Welcome Guest! <b style="color: yellow">Shopping Cart:</b> Total Items: <?php echo total_items(); ?> Total Price: <?php echo "$" . total_price(); ?> <a href="cart.php" style="color: yellow">Go to Cart</a>
					</span>
				</div>
				...
				<form method="post" action="customer_register.php" enctype="multipart/form-data">
					<table align="center" width="750px">
						...
						<tr>
							...
							<td><textarea cols="25" rows="10" name="c_address" required></textarea></td>
						</tr>
						<tr align="center">
